...
def rest():
	...
	#-------------------------------1. Install base--------------------------------
	ENB_install_fullpath, Mash_install_fullpath, MO_install_fullpath, SKSE_install_fullpath, TES5E_install_fullpath = m2utils_install.get_utilities_paths(download_cache_folder, filenames_list_in_order)
